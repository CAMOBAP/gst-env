...
class GstenvConan(ConanFile):
    ...
    def build(self):
        #tools.out.info("-------------------------------1")
        #tools.out.info(self.requires)
        #tools.out.info("-------------------------------2")
        #tools.out.info(self.deps_cpp_info.include_paths)
        #tools.out.info("-------------------------------3")
        #tools.out.info(self.deps_cpp_info.lib_paths)
        #tools.out.info("-------------------------------4")
        #tools.out.info(self.deps_cpp_info.bin_paths)
        #tools.out.info("-------------------------------5")
        #tools.out.info(self.deps_cpp_info.build_paths)
        #tools.out.info("-------------------------------6")
